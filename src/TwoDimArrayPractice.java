...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void printArray( )
   {
    ...
    // Write your code here:
       ...
       for (int i = 0; i < intArray.length; i++) {
           System.out.print(i + "\t");
           for (int num = 0; num < intArray[i].length; num++) {
               System.out.print(intArray[i][num] + " ");
               animate(i, num);
           }
           System.out.println();
       }
   ...
   public void setValues( int value, int row )
   {
    ...
    // Write your code here:
       ...
       if (row >= 0 && row < intArray.length) {
           for (int num = 0; num < intArray[row].length; num++) {
               intArray[row][num] = value;
               animate(row, num);
           }
       }
   }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
       int minimum=0;
       if(column>=0 && column<intArray[0].length){
           for(int i = 0; i < intArray.length; i++){
               if( i == 0){
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
       ...
       int counter = 0;
       for (int i = 0; i < intArray.length; i++) {
           for (int column = 0; column < intArray[i].length; column++) {
               if(intArray[i][column]==value){
                   counter ++;
               }
               animate(i, column,counter);
           }
       }
       return counter;
   }
